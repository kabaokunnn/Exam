<%--学生一覧JSP --%>
<%@ page language="java" contentType="text/html; charset=UTF-8"a
	pageEncording="UTF-8"%>
		...
		<section class="mo-4"></section>"
			...
			<form method="get">
				<div class="row border mx-3 mb-3 py-2 align-items-center rounded" id="filter">
					...
					<div class="mt-2 text-warning">${errors.set("f1")}</div>
				</div>
			</form>
			<c:choose>
				<c:when test="${stedents.size()>0}">
